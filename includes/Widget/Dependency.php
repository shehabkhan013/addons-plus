...
class Dependency {
	...
	public function get_widgets_styles() {
		return [
			...
			'addons-plus-wp-forms-style'      => [
				'src'     => ADDONS_PLUS_URL . 'assets/widgets/css/wp-forms.css',
				'version' => filemtime( ADDONS_PLUS_PATH . 'assets/widgets/css/wp-forms.css' ),
			],
			'addons-plus-ninja-forms-style'   => [
				'src'     => ADDONS_PLUS_URL . 'assets/widgets/css/ninja-forms.css',
				'version' => filemtime( ADDONS_PLUS_PATH . 'assets/widgets/css/ninja-forms.css' ),
			],
			'addons-plus-caldera-forms-style' => [
				'src'     => ADDONS_PLUS_URL . 'assets/widgets/css/caldera-forms.css',
				'version' => filemtime( ADDONS_PLUS_PATH . 'assets/widgets/css/caldera-forms.css' ),
			],
			'addons-plus-gravity-forms-style' => [
				'src'     => ADDONS_PLUS_URL . 'assets/widgets/css/gravity-forms.css',
				'version' => filemtime( ADDONS_PLUS_PATH . 'assets/widgets/css/gravity-forms.css' ),
			]
		];
	}
