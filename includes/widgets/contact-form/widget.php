	...
	protected function render() {
        ...
        <div class="adp-cform-wrapper ui form">
            <form class="adp-cform" method="post">
                ...
                <div class="adp-cform-header" style="text-align: <?php echo esc_attr( $settings[ 'ingo_alignment' ] );?>">
                ...
                ?>
                <div class="adp-cfrom-btn-wrap" style="text-align: <?php echo esc_attr( $settings[ 'button_alignment' ]);?>">
                    <button  type="submit" class="contact_button ui button"><?php echo esc_html($settings['button_text']) ;?></button>
                </div>
