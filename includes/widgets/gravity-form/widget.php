...
/**
 * Elementor GravityForm
 *
 * Elementor widget for GravityForm.
 *
 * @since 1.0.0
 */
class Gravity_Form extends Widget_Base {
	...
	public function get_style_depends() {
		return [ 'addons-plus-gravity-forms-style' ];
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			...
			[
				'label' => ha_is_gravityforms_activated() ? __( 'Gravity Forms', 'addons-plus' ) : __( 'Missing Notice',
					'addons-plus' ),
				'tab'   => Controls_Manager::TAB_CONTENT,
			]
		);

		if ( ! Initializations::is_gravityforms_activated() ) {
			$this->add_control(
				'_gravityforms_missing_notice',
				[
					'type'            => Controls_Manager::RAW_HTML,
					'raw'             => sprintf(
						__( 'Hello %1$s, looks like Gravity Forms is missing in your site. Please install/activate Gravity Forms. Make sure to refresh this page after installation or activation.', 'addons-plus' ),
		...
		$this->add_control(
			...
			[
				...
				'label_block' => true,
				'options'     => [ '' => __( 'Select a Gravity Forms', 'addons-plus' ) ] + Initializations::get_gravity_form(),
			]
		);
		$this->add_control(
			'form_title_show',
			[
				...
				'separator'    => 'before',
				'label_on'     => __( 'Show', 'addons-plus' ),
				'label_off'    => __( 'Hide', 'addons-plus' ),
				'return_value' => 'yes',
				'default'      => 'yes',
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .adp-gravity-form-wraper',
			]
		);
		$this->add_control(
			'border_radius',
			[
				...
				'size_units' => [ 'px', '%', 'em' ],
				'selectors'  => [
					'{{WRAPPER}} .adp-gravity-form-wraper' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		$this->add_control(
			...
			[
				...
				'size_units' => [ 'px', '%', 'em' ],
				'selectors'  => [
					'{{WRAPPER}} .adp-gravity-form-wraper' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		$this->end_controls_section();
		...
		$this->add_control(
			...
			[
				...
				'size_units'         => [ 'px' ],
				'selectors'          => [
					'{{WRAPPER}} .gform_heading h3' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				]
			]
		);
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .gform_heading h3',
			]
		);
		$this->add_control(
			'subheading_margin',
		...
		$this->add_responsive_control(
			'large_field_width',
			[
				'label'      => __( 'Large Field Width', 'addons-plus' ),
		...
		$this->add_responsive_control(
			'label_padding',
			[
				'label'      => __( 'Label Padding', 'addons-plus' ),
				'type'       => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', '%' ],
				'selectors'  => [
		...
		$this->add_responsive_control(
			'sub_label_margin',
			[
				'label'      => __( 'Sub Label Margin', 'addons-plus' ),
				'type'       => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', '%' ],
				'separator'  => 'after',
				'selectors'  => [
		...
		$this->add_control(
			'submit_btn_position',
			[
				'label'     => __( 'Button Position', 'addons-plus' ),
		...
		$this->add_control(
			'section_break',
			[
				'label' => __( 'Section Break', 'addons-plus' ),
		...
		$this->add_group_control(
			...
			[
				...
				'label'    => __( 'Title Typography', 'addons-plus' ),
		...
		$this->start_controls_tab(
			...
			[
				'label' => __( 'Description', 'addons-plus' ),
			]
		);
		...
		$this->add_control(
			'page_break',
			[
				'label'     => __( 'Page Break', 'addons-plus' ),
				'type'      => Controls_Manager::HEADING,
				'separator' => 'before'
			]
		);
		...
		$this->add_control(
			...
			[
				'label'     => __( 'Progress bar background Color', 'addons-plus' ),
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_control(
			...
			[
				'label'      => __( 'Button Padding', 'addons-plus' ),
				'type'       => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', '%' ],
				'selectors'  => [
		...
		$this->add_group_control(
			...
			[
				...
				'label'    => __( 'Button Box Shadow', 'addons-plus' ),
		...
		$this->add_control(
			...
			[
				'label'      => __( 'Button Border Radius', 'addons-plus' ),
				'type'       => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', '%' ],
				'selectors'  => [
		...
		$this->add_group_control(
			...
			[
				...
				'label'    => __( 'Button Typography', 'addons-plus' ),
				'selector' => '{{WRAPPER}} .gform_next_button.button, {{WRAPPER}} .gform_previous_button.button',
				'scheme'   => Scheme_Typography::TYPOGRAPHY_4
			]
		);
		...
		$this->add_responsive_control(
			'list_button_size',
			[
				'label'      => __( 'Button Size', 'addons-plus' ),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => [ 'px' ],
				'default'    => [
					'unit' => 'px',
		...
		$this->add_control(
			...
			[
				'label'     => __( 'Background Color (Even)', 'addons-plus' ),
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_control(
			...
			[
				'label'     => __( 'Background Color (Odd)', 'addons-plus' ),
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
	...
	protected function render() {
		...
		isset( $settings['html_class'] ) ? $settings['html_class'] : '';
		?>
        <div class="adp-gravity-form-wraper <?php echo esc_attr( $settings['html_class'] ); ?>">
			<?php
